...
- [ ] 2. Implement Configuration Manager
  - [ ] 2.1 Create configuration schema in package.json
...
- [ ] 3. Implement Command Executor
  - [ ] 3.1 Create CommandExecutor class with shell command building
  ...
  - [ ] 3.2 Implement command execution with child_process
  ...
  - [ ] 3.3 Add error handling and result formatting
...
- [ ] 4. Implement Hover Manager
  - [ ] 4.1 Create HoverManager class with output storage
...
- [ ] 5. Implement main extension command
  - [ ] 5.1 Create command handler in extension.ts
    - Get active editor and selected text
    - Validate that text is selected
    - Show error message if no selection exists
    - _Requirements: 1.1, 4.3_
  
  - [ ] 5.2 Integrate command execution with progress feedback
  ...
  - [ ] 5.3 Handle execution results and store for hover
...
- [ ] 6. Wire up extension activation and registration
  - [ ] 6.1 Implement activate() function
...
- [ ] 8. Create extension documentation
  - [ ] 8.1 Write README.md with usage instructions
